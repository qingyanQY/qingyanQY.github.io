...
function(i, t, n, s) {
	...
	e.prototype = {
		...
		handleClick: function(n) {
			...
			o = e.parent(),
			a = "#" + s.getHash(e);
			o.hasClass(s.config.currentClass) || (s.config.begin && s.config.begin(), s.adjustNav(s, o), s.unbindInterval(), s.scrollTo(a,
			function() {
